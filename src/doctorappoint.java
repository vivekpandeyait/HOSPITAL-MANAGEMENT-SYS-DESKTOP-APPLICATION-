 ...
 * @author OM SAI RAM
 */
public class doctorappoint extends javax.swing.JFrame {
    ...
    /**
     * Creates new form doctorappoint
     */
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(20, 80, 81, 31);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(doctorappoint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new doctorappoint().setVisible(true);
            }
        });
    }
